...
local PlayFabServerApi = require(script.Parent.PlayFabServerApi)

local PlayFabClientApi = {
    settings = PlayFabSettings.settings
}

function PlayFabClientApi.IsClientLoggedIn(playfabId)
    return (PlayFabSettings._internalSettings.sessionTickets[playfabId])
    --return (not (sessionTicket == nil))
end
...
function PlayFabClientApi.AcceptTrade(request, onSuccess, onError)
    local sessionTicket = PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/AcceptTrade", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.AddFriend(request, onSuccess, onError)
    local sessionTicket = PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/AddFriend", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.AddGenericID(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/AddGenericID", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.AddOrUpdateContactEmail(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/AddOrUpdateContactEmail", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.AddSharedGroupMembers(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/AddSharedGroupMembers", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.AddUsernamePassword(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/AddUsernamePassword", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.AddUserVirtualCurrency(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/AddUserVirtualCurrency", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.AndroidDevicePushNotificationRegistration(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/AndroidDevicePushNotificationRegistration", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.AttributeInstall(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/AttributeInstall", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.CancelTrade(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/CancelTrade", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.ConfirmPurchase(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/ConfirmPurchase", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.ConsumeItem(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/ConsumeItem", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.ConsumeMicrosoftStoreEntitlements(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/ConsumeMicrosoftStoreEntitlements", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.ConsumePS5Entitlements(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/ConsumePS5Entitlements", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.ConsumePSNEntitlements(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/ConsumePSNEntitlements", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.ConsumeXboxEntitlements(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/ConsumeXboxEntitlements", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.CreateSharedGroup(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/CreateSharedGroup", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.ExecuteCloudScript(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/ExecuteCloudScript", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetAccountInfo(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetAccountInfo", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetAdPlacements(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetAdPlacements", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetAllUsersCharacters(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetAllUsersCharacters", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetCatalogItems(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetCatalogItems", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetCharacterData(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetCharacterData", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetCharacterInventory(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetCharacterInventory", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetCharacterLeaderboard(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetCharacterLeaderboard", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetCharacterReadOnlyData(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetCharacterReadOnlyData", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetCharacterStatistics(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetCharacterStatistics", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetContentDownloadUrl(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetContentDownloadUrl", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetCurrentGames(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetCurrentGames", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetFriendLeaderboard(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetFriendLeaderboard", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetFriendLeaderboardAroundPlayer(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetFriendLeaderboardAroundPlayer", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetFriendsList(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetFriendsList", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetGameServerRegions(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetGameServerRegions", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetLeaderboard(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetLeaderboard", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetLeaderboardAroundCharacter(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetLeaderboardAroundCharacter", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetLeaderboardAroundPlayer(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetLeaderboardAroundPlayer", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetLeaderboardForUserCharacters(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetLeaderboardForUserCharacters", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetPaymentToken(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetPaymentToken", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetPhotonAuthenticationToken(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetPhotonAuthenticationToken", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetPlayerCombinedInfo(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetPlayerCombinedInfo", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetPlayerProfile(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetPlayerProfile", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetPlayerSegments(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetPlayerSegments", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetPlayerStatistics(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetPlayerStatistics", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetPlayerStatisticVersions(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetPlayerStatisticVersions", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetPlayerTags(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetPlayerTags", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetPlayerTrades(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetPlayerTrades", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetPlayFabIDsFromFacebookIDs(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetPlayFabIDsFromFacebookIDs", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetPlayFabIDsFromFacebookInstantGamesIds(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetPlayFabIDsFromFacebookInstantGamesIds", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetPlayFabIDsFromGameCenterIDs(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetPlayFabIDsFromGameCenterIDs", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetPlayFabIDsFromGenericIDs(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetPlayFabIDsFromGenericIDs", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetPlayFabIDsFromGoogleIDs(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetPlayFabIDsFromGoogleIDs", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetPlayFabIDsFromKongregateIDs(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetPlayFabIDsFromKongregateIDs", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetPlayFabIDsFromNintendoSwitchDeviceIds(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetPlayFabIDsFromNintendoSwitchDeviceIds", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetPlayFabIDsFromPSNAccountIDs(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetPlayFabIDsFromPSNAccountIDs", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetPlayFabIDsFromSteamIDs(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetPlayFabIDsFromSteamIDs", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetPlayFabIDsFromTwitchIDs(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetPlayFabIDsFromTwitchIDs", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetPlayFabIDsFromXboxLiveIDs(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetPlayFabIDsFromXboxLiveIDs", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetPublisherData(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetPublisherData", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetPurchase(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetPurchase", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetSharedGroupData(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetSharedGroupData", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetStoreItems(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetStoreItems", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetTime(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetTime", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
PlayFabClientApi.GetTitleData = PlayFabServerApi.GetTitleData
--[[function PlayFabClientApi.GetTitleData(request, playfabId, onSuccess, onError)
    local sessionTicket = sessionTickets[playfabId]
    if not sessionTicket then error("Must be logged in to call this method") end
    print(request, playfabId, onSuccess, onError, sessionTicket)
    --local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetTitleData", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
]]
...
function PlayFabClientApi.GetTitleNews(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetTitleNews", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetTradeStatus(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetTradeStatus", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetUserData(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetUserData", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetUserInventory(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetUserInventory", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetUserPublisherData(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetUserPublisherData", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetUserPublisherReadOnlyData(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetUserPublisherReadOnlyData", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GetUserReadOnlyData(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GetUserReadOnlyData", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.GrantCharacterToUser(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/GrantCharacterToUser", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.LinkAndroidDeviceID(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/LinkAndroidDeviceID", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.LinkApple(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/LinkApple", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.LinkCustomID(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/LinkCustomID", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.LinkFacebookAccount(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/LinkFacebookAccount", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.LinkFacebookInstantGamesId(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/LinkFacebookInstantGamesId", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.LinkGameCenterAccount(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/LinkGameCenterAccount", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.LinkGoogleAccount(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/LinkGoogleAccount", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.LinkIOSDeviceID(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/LinkIOSDeviceID", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.LinkKongregate(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/LinkKongregate", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.LinkNintendoServiceAccount(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/LinkNintendoServiceAccount", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.LinkNintendoSwitchDeviceId(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/LinkNintendoSwitchDeviceId", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.LinkOpenIdConnect(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/LinkOpenIdConnect", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.LinkPSNAccount(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/LinkPSNAccount", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.LinkSteamAccount(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/LinkSteamAccount", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.LinkTwitch(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/LinkTwitch", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.LinkXboxAccount(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/LinkXboxAccount", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.Matchmake(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/Matchmake", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.OpenTrade(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/OpenTrade", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.PayForPurchase(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/PayForPurchase", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.PurchaseItem(request, onSuccess, onError)
    local sessionTicket = PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/PurchaseItem", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.RedeemCoupon(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/RedeemCoupon", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.RefreshPSNAuthToken(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/RefreshPSNAuthToken", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.RegisterForIOSPushNotification(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/RegisterForIOSPushNotification", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.RemoveContactEmail(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/RemoveContactEmail", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.RemoveFriend(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/RemoveFriend", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.RemoveGenericID(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/RemoveGenericID", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.RemoveSharedGroupMembers(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/RemoveSharedGroupMembers", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.ReportAdActivity(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/ReportAdActivity", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.ReportDeviceInfo(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/ReportDeviceInfo", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.ReportPlayer(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/ReportPlayer", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.RestoreIOSPurchases(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/RestoreIOSPurchases", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.RewardAdActivity(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/RewardAdActivity", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.SetFriendTags(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/SetFriendTags", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.SetPlayerSecret(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/SetPlayerSecret", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.StartGame(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/StartGame", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.StartPurchase(request, onSuccess, onError)
    local sessionTicket = PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  
    if not sessionTicket then error("Must be logged in to call this method") end 
    print(request)
    IPlayFabHttps.MakePlayFabApiCall("/Client/StartPurchase", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.SubtractUserVirtualCurrency(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/SubtractUserVirtualCurrency", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.UnlinkAndroidDeviceID(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/UnlinkAndroidDeviceID", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.UnlinkApple(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/UnlinkApple", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.UnlinkCustomID(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/UnlinkCustomID", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.UnlinkFacebookAccount(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/UnlinkFacebookAccount", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.UnlinkFacebookInstantGamesId(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/UnlinkFacebookInstantGamesId", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.UnlinkGameCenterAccount(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/UnlinkGameCenterAccount", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.UnlinkGoogleAccount(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/UnlinkGoogleAccount", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.UnlinkIOSDeviceID(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/UnlinkIOSDeviceID", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.UnlinkKongregate(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/UnlinkKongregate", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.UnlinkNintendoServiceAccount(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/UnlinkNintendoServiceAccount", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.UnlinkNintendoSwitchDeviceId(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/UnlinkNintendoSwitchDeviceId", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.UnlinkOpenIdConnect(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/UnlinkOpenIdConnect", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.UnlinkPSNAccount(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/UnlinkPSNAccount", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.UnlinkSteamAccount(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/UnlinkSteamAccount", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.UnlinkTwitch(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/UnlinkTwitch", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.UnlinkXboxAccount(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/UnlinkXboxAccount", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.UnlockContainerInstance(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/UnlockContainerInstance", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.UnlockContainerItem(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/UnlockContainerItem", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.UpdateAvatarUrl(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/UpdateAvatarUrl", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.UpdateCharacterData(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/UpdateCharacterData", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.UpdateCharacterStatistics(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/UpdateCharacterStatistics", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.UpdatePlayerStatistics(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/UpdatePlayerStatistics", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.UpdateSharedGroupData(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/UpdateSharedGroupData", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.UpdateUserData(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/UpdateUserData", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.UpdateUserPublisherData(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/UpdateUserPublisherData", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.UpdateUserTitleDisplayName(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/UpdateUserTitleDisplayName", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.ValidateAmazonIAPReceipt(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/ValidateAmazonIAPReceipt", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.ValidateGooglePlayPurchase(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/ValidateGooglePlayPurchase", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.ValidateIOSReceipt(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/ValidateIOSReceipt", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.ValidateWindowsStoreReceipt(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/ValidateWindowsStoreReceipt", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.WriteCharacterEvent(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/WriteCharacterEvent", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.WritePlayerEvent(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/WritePlayerEvent", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
...
function PlayFabClientApi.WriteTitleEvent(request, onSuccess, onError)
    local sessionTicket =PlayFabClientApi.IsClientLoggedIn(request.PlayFabId)  if not sessionTicket then error("Muse be logged in to call this method") end 
    IPlayFabHttps.MakePlayFabApiCall("/Client/WriteTitleEvent", request, "X-Authorization", sessionTicket, onSuccess, onError)
end
